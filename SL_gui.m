...
function handles = popup_materialSystem_Callback(hObject, eventdata, handles)
    ...
    switch get(handles.popup_materialSystem, 'Value')
        case 1,     handles.d_a = a.TNS/handles.divide_uc;   
                    handles.d_b = a.HNS/handles.divide_uc;   
                    handles.matSyst = 'TNS/HNS';
        case 2,     handles.d_a = a.HNS/handles.divide_uc;   
                    handles.d_b = a.TNS/handles.divide_uc;   
                    handles.matSyst = 'HNS/TNS';
        case 3,     handles.d_a = a.TNS/handles.divide_uc;   
                    handles.d_b = a.ZHNS/handles.divide_uc;  
                    handles.matSyst = 'TNS/ZHNS';
        case 4,     handles.d_a = a.ZHNS/handles.divide_uc;  
                    handles.d_b = a.TNS/handles.divide_uc;   
                    handles.matSyst = 'ZHNS/TNS';
        case 5,     handles.d_a = a.HNS/handles.divide_uc;   
                    handles.d_b = a.ZHNS/handles.divide_uc;  
                    handles.matSyst = 'HNS/ZHNS';
        case 6,     handles.d_a = a.ZHNS/handles.divide_uc;  
                    handles.d_b = a.HNS/handles.divide_uc;   
                    handles.matSyst = 'ZHNS/HNS';
        case 7,     handles.d_a = a.ZNS/handles.divide_uc;   
                    handles.d_b = a.TNS/handles.divide_uc;   
                    handles.matSyst = 'ZNS/TNS';
        case 8,     handles.d_a = a.TNS/handles.divide_uc;   
                    handles.d_b = a.ZNS/handles.divide_uc;   
                    handles.matSyst = 'TNS/ZNS';
        case 9,     handles.d_a = a.ZNS/handles.divide_uc;   
                    handles.d_b = a.HNS/handles.divide_uc;   
                    handles.matSyst = 'ZNS/HNS';
        case 10,    handles.d_a = a.HNS/handles.divide_uc;   
                    handles.d_b = a.ZNS/handles.divide_uc;   
                    handles.matSyst = 'HNS/ZNS';
        case 11,    handles.d_a = a.ZNS/handles.divide_uc;   
                    handles.d_b = a.ZHNS/handles.divide_uc;  
                    handles.matSyst = 'ZNS/ZHNS';
        case 12,    handles.d_a = a.ZHNS/handles.divide_uc;  
                    handles.d_b = a.ZNS/handles.divide_uc;   
                    handles.matSyst = 'ZHNS/ZNS';
    end
...
function slider_numberOfUC_A_Callback(hObject, eventdata, handles)
    set(handles.edit_numberOfUCCurrent_A, 'String', get(handles.slider_numberOfUC_A, 'Value'));
        handles.d_a = str2num(get(handles.edit_numberOfUCCurrent_A, 'String'))/handles.divide_uc;
        set(handles.text_thickness_A, 'String', handles.d_a*handles.divide_uc*str2num(get(handles.edit_thicknessCurrent_A, 'String'))/10);
...
function slider_numberOfUC_B_Callback(hObject, eventdata, handles)
    set(handles.edit_numberOfUCCurrent_B, 'String', get(handles.slider_numberOfUC_B, 'Value'));
        handles.d_b = str2num(get(handles.edit_numberOfUCCurrent_B, 'String'))/handles.divide_uc;
        set(handles.text_thickness_B, 'String', handles.d_b*handles.divide_uc*str2num(get(handles.edit_thicknessCurrent_B, 'String'))/10);
            handles = simulate(handles);
                guidata(hObject, handles);
            plot_xrd(handles);
...
if isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    ...
    handles.d_b = str2num(get(handles.edit_numberOfUCCurrent_B, 'String'))/handles.divide_uc;
    set(handles.text_thickness_B, 'String', handles.d_b*handles.divide_uc*str2num(get(handles.edit_thicknessCurrent_A, 'String'))/10);    
...
function checkbox_bufferLayer_Callback(hObject, eventdata, handles)
    if get(handles.checkbox_bufferLayer, 'Value')
        ...
        handles.UnitCell_buffer = 5.94/handles.divide_uc;
    ...
    function handles = popup_chooseBufferLayer_Callback(hObject, eventdata, handles)
        ...
        a.TNS = 5.94/handles.divide_uc; a.HNS = 6.08/handles.divide_uc;
        a.ZNS = 6.11/handles.divide_uc; a.ZHNS = 6.1082/handles.divide_uc; 
        a.V = 6.2/handles.divide_uc;
    ...
    function popup_chooseBufferLayer_CreateFcn(hObject, eventdata, handles)
        ...
        function slider_thicknessBufferLayer_Callback(hObject, eventdata, handles)
            set(handles.edit_thicknessCurrent_buffer, 'String', get(handles.slider_thicknessBufferLayer, 'Value'));
            set(handles.slider_relaxationLength, 'Max', handles.divide_uc*str2double(get(handles.edit_thicknessCurrent_buffer, 'String')));
            set(handles.edit_relaxationTo, 'String', handles.divide_uc*str2double(get(handles.edit_thicknessCurrent_buffer, 'String')));
...
function edit_relaxationTo_Callback(hObject, eventdata, handles)
    set(handles.edit_relaxationTo, 'String', handles.divide_uc*get(handles.edit_thicknessCurrent_buffer, 'String'));
...
function edit_intermixingcurrent_A_Callback(hObject, eventdata, handles)
    ...
    if str2double(get(handles.edit_thicknessCurrent_A, 'String')) < str2num(get(handles.edit_intermixingcurrent_A, 'String'))
        set(handles.edit_intermixingcurrent_A, 'String', floor(srt2double(get(handles.edit_thicknessCurrent_A, 'String'))*handles.divide_uc/2)/handles.divide_uc);
        set(handles.slider_intermixingA, 'Value', floor(srt2double(get(handles.edit_thicknessCurrent_A, 'String'))*handles.divide_uc/2)/handles.divide_uc);
...
function edit_intermixingcurrent_B_Callback(hObject, eventdata, handles)
    ...
    if str2double(get(handles.edit_thicknessCurrent_B, 'String')) < str2num(get(handles.edit_intermixingcurrent_B, 'String'))
        set(handles.edit_intermixingcurrent_B, 'String', floor(srt2double(get(handles.edit_thicknessCurrent_B, 'String'))*handles.divide_uc/2)/handles.divide_uc);
        set(handles.slider_intermixingB, 'Value', floor(srt2double(get(handles.edit_thicknessCurrent_B, 'String'))*handles.divide_uc/2)/handles.divide_uc);
...
function menu_file_Callback(hObject, eventdata, handles)
    ...
    switch filterindex
        ...
        case 3 % save as .xlsx
            ...
            DateAndTime = sprintf('%s, %0.f:%0.f:%0.f', d, c(4), c(5), c(6));
                ...
                if get(handles.checkbox_varyLatticeParameters, 'Value')
                    ...
                    S(8,2)  = num2cell(handles.d_a*handles.divide_uc);
                    S(12,2) = num2cell(handles.d_b*handles.divide_uc);
                end
        ...
        function menu_loadXlsx_Callback(hObject, eventdata, handles)
            ...
            handles = loadSavedXLSXSimulation(index);
