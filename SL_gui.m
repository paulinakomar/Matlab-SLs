...
% Last Modified by GUIDE v2.5 05-Feb-2015 15:15:54
...
s2min = str2num(get(handles.nFrom_B, 'String'));
 ...
 if buffer_YN
    ...
    buffer_thickness = str2double(get(handles.BufferThickness, 'String'));
 else
     buffer_material = 0;
     Nlayers_buffer = 0;
...
if get(handles.RelaxationAndStrain_checkbox, 'Value')
    ...
    [handles.twotheta1, handles.twotheta2,...
        ...
        d_buffer, d_a, d_b, Nrelaxation);
    plot_xrd(handles);
    
    A_thickness_nm = str2double(get(handles.Thickness_A, 'String'));
    B_thickness_nm = str2double(get(handles.Thickness_B, 'String'));
    set(handles.TotalThickness, 'String',...
        buffer_thickness + NoPeriods * (A_thickness_nm + B_thickness_nm));
...
function handles = plot_xrd(handles)
    ...
    % third plot
    if isfield(handles, 'color')
        semilogy(handles.plot_T_2T_200_log, handles.twotheta1, handles.IntensityGauss1,...
            'Color', handles.color, 'LineWidth', str2num(handles.LWidth{1}));
    else semilogy(handles.plot_T_2T_200_log, handles.twotheta1, handles.IntensityGauss1,...
            'r', 'LineWidth', str2num(handles.LWidth{1}));
    end
            ...
            if isfield(handles, 'T2T_200')
                if isfield(handles, 'color') && isfield(handles, 'colormeas')
                    set(handles.plot_T_2T_200_log, 'ColorOrder', [handles.color; handles.colormeas],...
                        ...
                        'FontUnits', handles.Font.FontUnits, 'FontSize', handles.Font.FontSize);
                    plot(handles.plot_T_2T_200_log, handles.twotheta1, handles.IntensityGauss1,... 
                        handles.T2T_200.data(:,1), handles.T2T_200.data(:,2)/max(handles.T2T_200.data(:,2)),...
                        'LineWidth', str2num(handles.LWidth{1}));
                elseif isfield(handles, 'color') && ~isfield(handles, 'colormeas')
    ...
    % fourth plot
    if isfield(handles, 'color')
        semilogy(handles.plot_T_2T_400_log, handles.twotheta2, handles.IntensityGauss2,...
            'Color', handles.color, 'LineWidth', str2num(handles.LWidth{1}));
    else
        semilogy(handles.plot_T_2T_400_log, handles.twotheta2, handles.IntensityGauss2,...
            'r', 'LineWidth', str2num(handles.LWidth{1}));
            ...
            if isfield(handles, 'T2T_400')
                if isfield(handles, 'color') && isfield(handles, 'colormeas')
                    set(handles.plot_T_2T_400_log, 'ColorOrder', [handles.color; handles.colormeas],...
                        ...
                        'FontWeight', handles.Font.FontWeight, 'FontAngle', handles.Font.FontAngle,...
                        'FontUnits', handles.Font.FontUnits, 'FontSize', handles.Font.FontSize);
                    plot(handles.plot_T_2T_400_log, handles.twotheta2, handles.IntensityGauss2,... 
                        handles.T2T_400.data(:,1), handles.T2T_400.data(:,2)/max(handles.T2T_400.data(:,2)),...
                        'LineWidth', str2num(handles.LWidth{1}));
                elseif isfield(handles, 'color') && ~isfield(handles, 'colormeas')
...
function TotalThickness_CreateFcn(hObject, eventdata, handles)
% hObject    handle to TotalThickness (see GCBO)
