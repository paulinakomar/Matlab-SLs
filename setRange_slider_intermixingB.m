function setRange_slider_intermixingB(handles)
    s2min = 0;
    s2max = floor(str2double(get(handles.edit_thicknessCurrent_B, 'String'))*handles.divide_uc/2)/handles.divide_uc;
    ...
    if s2max < str2num(get(handles.edit_intermixingcurrent_B, 'String'))
        ...
        set(handles.edit_intermixingfrom_B, 'String', s2min);
            set(handles.slider_intermixingB, 'SliderStep', [1 1]/(handles.divide_uc*(s2max-s2min)));
