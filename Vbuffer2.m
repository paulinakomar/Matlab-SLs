...
d_a=0; % best: 5.91   Lit: 5.941  Gitterkonstante TiNiSn / 4 = echter Netzebenenabstand der Atomlagen im Realraum
d_b=0; % best: 6.17   Lit: 6.070  Gitterkonstante Zr05Hf05NiSn
d_inter=(d_a+d_b)/2;
...
N_buffer=6;   % Anzahl EZ NiTiSn buffer bzw Halbe Anzahl EZ V Lagen (sollten 16 sein)
N_bilayer=0; % Anzahl Wiederholungen
N_EZ_a=0; % 13 TiNiSn  Anzahl der Elementarzellen; muss in aktueller Version in 1/4 Schritten gewaehlt werden!
N_EZ_b=0; % 13 Zr05Hf05 NiSn
