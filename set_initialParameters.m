...
s2min = str2num(get(handles.edit_thicknessFrom_B, 'String'));
    ...
    set(handles.slider_thicknessLayerB, 'SliderStep', [1 1]/(4*(s2max-s2min)));
...
if get(handles.checkbox_intermixing, 'Value')
    ...
    dev_thicknessUC_a = 0.25;%
    set(handles.edit_UCRange_layerA, 'String', 0.25);
    dev_thicknessUC_b = 0.25;%
    set(handles.edit_UCRange_layerB, 'String', 0.25);
