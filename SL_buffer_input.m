...
d_perm_a = GaussDistributionOfUCSize(divide_uc*d_a, range_UCSize_a, std_dev_normal_ucSize_a, max(N_planes_a))/divide_uc;
d_perm_b = GaussDistributionOfUCSize(divide_uc*d_b, range_UCSize_b, std_dev_normal_ucSize_b, max(N_planes_b))/divide_uc;
